...
void MicroRosCommunication::pwm_sub_cb(const void *msgin)
{
  ...
  motor1.setSpeed(abs(msg->pwm1), (msg->pwm1 > 0) ? 1 : 0);
  motor2.setSpeed(abs(msg->pwm2), (msg->pwm2 > 0) ? 1 : 0);
  motor3.setSpeed(abs(msg->pwm3), (msg->pwm3 > 0) ? 1 : 0);
  motor4.setSpeed(abs(msg->pwm4), (msg->pwm4 > 0) ? 1 : 0);
}
